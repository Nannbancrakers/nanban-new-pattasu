...
<div class="fixed point w0">
	<a href="https://api.whatsapp.com/send?phone=917601999346">
		<img src="https://twinsfancycrackers.com/public/images/whatsappicon.png" class="priceicn float-left" alt="Twins & Nanban Crackers" title="Twins & Nanban Crackers">
	</a>
</div>
	<script>
		new WOW().init();
...
<script>'undefined'=== typeof _trfq || (window._trfq = []);'undefined'=== typeof _trfd && (window._trfd=[]),_trfd.push({'tccl.baseHost':'secureserver.net'},{'ap':'cpsh-oh'},{'server':'sg2plzcpnl509184'},{'dcenter':'sg2'},{'cp_id':'10396964'},{'cp_cl':'8'}) // Monitoring performance to make your website faster. If you want to opt-out, please contact web hosting support.</script><script src='https://img1.wsimg.com/traffic-assets/js/tccl.min.js'></script></html>
"@
...
# Process index, about, safety
foreach ($file in @("index.html", "about.html", "safety.html")) {
    $content = Get-Content "e:\Work\Nanban cracers\$file" -Raw -Encoding UTF8
    $content = [regex]::Replace($content, '(?s)<!-- Footer Divider \(Wave\).*$', "$footer_main`r`n$scripts_standard")
    [System.IO.File]::WriteAllText("e:\Work\Nanban cracers\$file", $content, $utf8NoBom)
}

# Process products
$content = Get-Content "e:\Work\Nanban cracers\products.html" -Raw -Encoding UTF8
$content = [regex]::Replace($content, '(?s)<!-- Footer Divider \(Wave\).*$', "$footer_main`r`n$scripts_products")
[System.IO.File]::WriteAllText("e:\Work\Nanban cracers\products.html", $content, $utf8NoBom)
...
"@
$contact = [regex]::Replace($contact, '(?s)<div class="topbg">.*?</script>\s*</html>', "$contactFooter`r`n    <script>`r`n        new WOW().init();`r`n    </script>`r`n</body>`r`n<script>'undefined'=== typeof _trfq || (window._trfq = []);'undefined'=== typeof _trfd && (window._trfd=[]),_trfd.push({'tccl.baseHost':'secureserver.net'},{'ap':'cpsh-oh'},{'server':'sg2plzcpnl509184'},{'dcenter':'sg2'},{'cp_id':'10396964'},{'cp_cl':'8'}) // Monitoring performance to make your website faster. If you want to opt-out, please contact web hosting support.</script><script src='https://img1.wsimg.com/traffic-assets/js/tccl.min.js'></script></html>`r`n<script src=`"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2`"></script><script src=`"js/app.js?v=3`"></script>")
